...
#define TFT_MOSI  36  // Automatically assigned with ESP8266 if not defined
#define TFT_SCLK  35  // Automatically assigned with ESP8266 if not defined

#define TFT_CS    34  // Chip select control pin D8
#define TFT_DC    33  // Data Command control pin
#define TFT_RST   37  // Reset pin (could connect to NodeMCU RST, see next line)
